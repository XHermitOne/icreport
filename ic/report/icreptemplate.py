...
В качестве тегов шаблона отчета могут быть:

[description]   -   Описание
[var]           -   Бэнд переменных
[generator]     -   Бэнд указания системы генерации
[data_source]   -   Бэнд указания источника данных для отчета/БД
[query]         -   Бэнд указания запроса для получения таблицы запроса
[style_lib]     -   Бэнд указания библиотеки стилей

[header]        -   Бэнд заголовка отчета (Координаты и размер)
[footer]        -   Бэнд подвала/примечания отчета (Координаты и размер)
[detail]        -   Бэнд области данных
[head_grp]      -   Список бэндов групп (Координаты и размер)
    Например:
    [head_grp]['VidEst'], где ['VidEst']-указание поля группы
[foot_grp]      -   Список бэндов групп (Координаты и размер)
    Например:
    [foot_grp]['VidEst'], где ['VidEst']-указание поля группы
