...
# -*- coding: utf-8 -*-
"""
Модуль преобразования индексов размеров бумаги 
в реальные размеры в сотых долях милиметра.
"""

# Константы размеров бумаги Excel
...
# Словарь преобразований констант Excel  в размеры бумаги
XL_PAPER_SIZE = {
